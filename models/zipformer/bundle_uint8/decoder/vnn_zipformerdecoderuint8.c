...
#include "vnn_zipformerdecoderuint8.h"
...
vsi_nn_graph_t * vnn_CreateZipformerDecoderUint8
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Gemm_/decoder_proj/Gemm/out0_0:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 512;
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.019897621124982834;
...
error:
    ...
    vnn_ReleaseZipformerDecoderUint8( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateZipformerDecoderUint8() */

void vnn_ReleaseZipformerDecoderUint8
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
...
} /* vsi_nn_ReleaseZipformerDecoderUint8() */
