...
#include "vnn_zipformerjoineruint8.h"
...
vsi_nn_graph_t * vnn_CreateZipformerJoinerUint8
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Gemm_/output_linear/Gemm/out0_0:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 5000;
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.12329325824975967;
...
error:
    ...
    vnn_ReleaseZipformerJoinerUint8( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateZipformerJoinerUint8() */

void vnn_ReleaseZipformerJoinerUint8
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
...
} /* vsi_nn_ReleaseZipformerJoinerUint8() */
