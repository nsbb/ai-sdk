#!/usr/bin/env python3
"""
Zipformer encoder folded4 dataset maker (31 inputs, all with batch=1 prefix)
- dataset0: x [1, 39, 80] mel features from real WAVs
- dataset1-30: zero-filled cache inputs with batch=1 prefix [1, N, ...]
"""
import numpy as np
import wave
import os
...
# dataset1-30: zero-filled float32 cache inputs with batch=1 prefix [1, N, ...]
# Shapes match the folded4 model inputs (with batch=1 prefix)
CACHE_SPECS = [
    ('cached_avg_0', (1, 2, 1, 384)),
    ('cached_avg_1', (1, 4, 1, 384)),
    ('cached_avg_2', (1, 3, 1, 384)),
    ('cached_avg_3', (1, 2, 1, 384)),
    ('cached_avg_4', (1, 4, 1, 384)),
    ('cached_key_0', (1, 2, 64, 1, 192)),
    ('cached_key_1', (1, 4, 32, 1, 192)),
    ('cached_key_2', (1, 3, 16, 1, 192)),
    ('cached_key_3', (1, 2, 8, 1, 192)),
    ('cached_key_4', (1, 4, 32, 1, 192)),
    ('cached_val_0', (1, 2, 64, 1, 96)),
    ('cached_val_1', (1, 4, 32, 1, 96)),
    ('cached_val_2', (1, 3, 16, 1, 96)),
    ('cached_val_3', (1, 2, 8, 1, 96)),
    ('cached_val_4', (1, 4, 32, 1, 96)),
    ('cached_val2_0', (1, 2, 64, 1, 96)),
    ('cached_val2_1', (1, 4, 32, 1, 96)),
    ('cached_val2_2', (1, 3, 16, 1, 96)),
    ('cached_val2_3', (1, 2, 8, 1, 96)),
    ('cached_val2_4', (1, 4, 32, 1, 96)),
    ('cached_conv1_0', (1, 2, 1, 384, 30)),
    ('cached_conv1_1', (1, 4, 1, 384, 30)),
    ('cached_conv1_2', (1, 3, 1, 384, 30)),
    ('cached_conv1_3', (1, 2, 1, 384, 30)),
    ('cached_conv1_4', (1, 4, 1, 384, 30)),
    ('cached_conv2_0', (1, 2, 1, 384, 30)),
    ('cached_conv2_1', (1, 4, 1, 384, 30)),
    ('cached_conv2_2', (1, 3, 1, 384, 30)),
    ('cached_conv2_3', (1, 2, 1, 384, 30)),
    ('cached_conv2_4', (1, 4, 1, 384, 30)),
]
