...
#include "vnn_wav2vec2base960h5s.h"
...
vsi_nn_graph_t * vnn_CreateWav2vec2Base960h5s
    (
...
error:
    ...
    vnn_ReleaseWav2vec2Base960h5s( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateWav2vec2Base960h5s() */

void vnn_ReleaseWav2vec2Base960h5s
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
...
} /* vsi_nn_ReleaseWav2vec2Base960h5s() */
