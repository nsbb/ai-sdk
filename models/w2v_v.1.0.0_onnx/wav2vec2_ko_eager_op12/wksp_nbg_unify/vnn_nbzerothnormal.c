...
vsi_nn_graph_t * vnn_CreateNbZerothNormal
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[2] = 1;
    attr.dim_num = 3;
    attr.dtype.scale = 0.06917193531990051;
    ...
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0007203345303423703;
...
error:
    ...
    vnn_ReleaseNbZerothNormal( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateNbZerothNormal() */

void vnn_ReleaseNbZerothNormal
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
