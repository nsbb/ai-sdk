...
#include "vnn_wav2vec2koeagerop123s.h"
...
vsi_nn_graph_t * vnn_CreateWav2vec2KoEagerOp123s
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[2] = 1;
    attr.dim_num = 3;
    attr.dtype.scale = 0.15027031302452087;
...
error:
    ...
    vnn_ReleaseWav2vec2KoEagerOp123s( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateWav2vec2KoEagerOp123s() */

void vnn_ReleaseWav2vec2KoEagerOp123s
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
...
} /* vsi_nn_ReleaseWav2vec2KoEagerOp123s() */
