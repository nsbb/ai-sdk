...
vsi_nn_graph_t * vnn_CreateNbZerothDfp16
    (
...
error:
    ...
    vnn_ReleaseNbZerothDfp16( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateNbZerothDfp16() */

void vnn_ReleaseNbZerothDfp16
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
