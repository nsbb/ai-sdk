...
vsi_nn_graph_t * vnn_CreateNbZerothMa
    (
...
error:
    ...
    vnn_ReleaseNbZerothMa( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateNbZerothMa() */

void vnn_ReleaseNbZerothMa
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
