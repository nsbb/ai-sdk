...
vsi_nn_graph_t * vnn_CreateNbZerothUint8
    (
...
error:
    ...
    vnn_ReleaseNbZerothUint8( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateNbZerothUint8() */

void vnn_ReleaseNbZerothUint8
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
