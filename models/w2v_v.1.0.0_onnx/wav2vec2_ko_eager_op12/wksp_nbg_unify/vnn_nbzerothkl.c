...
vsi_nn_graph_t * vnn_CreateNbZerothKl
    (
...
error:
    ...
    vnn_ReleaseNbZerothKl( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateNbZerothKl() */

void vnn_ReleaseNbZerothKl
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
