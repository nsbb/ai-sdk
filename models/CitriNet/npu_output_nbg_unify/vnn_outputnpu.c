...
vsi_nn_graph_t * vnn_CreateOutputNpu
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.030901169404387474;
...
error:
    ...
    vnn_ReleaseOutputNpu( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateOutputNpu() */

void vnn_ReleaseOutputNpu
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
